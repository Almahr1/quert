...
// - Real-world error handling and monitoring
// - Processing different types of web content
package main
...
// runCrawler executes the main crawling logic
...
// submitSeedURLs processes and submits initial URLs
func (d *CrawlerDemo) submitSeedURLs(ctx context.Context) error {
	// Get crawler config for seed URLs
...
// processResults handles crawl results and demonstrates content processing
...
// handleSuccessfulResult processes successful crawl results
func (d *CrawlerDemo) handleSuccessfulResult(result *crawler.CrawlResult) {
	...
	// Process extracted links for further crawling (if desired)
...
// processExtractedLinks demonstrates link processing for continued crawling
func (d *CrawlerDemo) processExtractedLinks(result *crawler.CrawlResult) {
	...
	for i, link := range content.Links {
		...
		// Process link through URL processor
...
// handleFailedResult processes failed crawl results
...
// printFinalStats displays final crawling statistics
